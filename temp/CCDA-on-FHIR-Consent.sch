...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>Contract.agent</sch:title>
    <sch:rule context="f:Contract/f:agent">
  ...
  <sch:pattern>
    <sch:title>Contract.valuedItem</sch:title>
  ...
  <sch:pattern>
    <sch:title>Contract.term.agent</sch:title>
    <sch:rule context="f:Contract/f:term/f:agent">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Contract.term.valuedItem</sch:title>
