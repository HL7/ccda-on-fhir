...
Usage: #example
Description: "Example composition for the Referral Note document profile."
* meta
  * versionId = "4"
  * lastUpdated = "2020-08-12T21:30:11.629+00:00"
  * source = "#csn482LCsnDWyxbW"
  * profile = "http://hl7.org/fhir/us/ccda/StructureDefinition/Referral-Note"
* language = #en-US
* identifier
...
* section[+]
  ...
  * text
    * status = #generated
    * div = "<div xmlns=\"http://www.w3.org/1999/xhtml\"><table><tr><td><b>Planned Activity</b></td><td><b>Period</b></td><td><b>Status</b></td></tr><tr><td>Colonoscopy</td><td>2016/08/16 - 2010/08/16</td><td>Completed</td></tr><tr><td>Recommendation to Exercise</td><td>2016/10/29</td><td>Ongoing</td></tr></table></div>"
* section[+]
