...
|**Status**<br/>```where observation/code@code="33999-4"```<br/>[/entryRelationship/observation/value]()|[.clinicalStatus]()|[CDA CD ↔ FHIR CodeableConcept]()
|**Reaction**<br/>```where entryRelationship@typeCode="MFST"```<br/>[/entryRelationship/observation/id]()|[.reaction[x].id]()<br/>
...
|**Criticality**<br/>```where observation/code@code="82606-5"```<br/>[/entryRelationship/observation/value]()|[.criticality]()|[CDA CD ↔ FHIR CodeableConcept]()<br/>[Allergy Criticality value → criticality]()
