...
- [Medication Mood → Intent](./ConceptMap-CF-MedActivityMood.html)
- [No Known Allergies (CDA) → negated code (FHIR)](./ConceptMap-CF-NoKnownAllergies.html)
- [C-CDA → FHIR Administrative Gender](./ConceptMap-CF-AdministrativeGender.html)
- [CDA Result Status → FHIR Observation Status](./ConceptMap-CF-ResultStatus.html)
- [Problem Concern Status → Condition Clinical Status](./ConceptMap-CF-ConditionClinicalStatus.html)
...
- [CDA Result Status → FHIR Report Status](./ConceptMap-CF-ResultReportStatus.html)
