...
The example below is generated from the canonical Myra Jones CCD (urgent-care encounter) and the published FHIR example instances, verified on every build. It demonstrates all five USCDI-3 Encounter Information elements; the encounter diagnosis becomes a separate Condition conforming to us-core-condition-encounter-diagnosis.

{% include examples/CF-encounter-example.xhtml %}
