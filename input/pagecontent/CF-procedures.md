...
|C-CDA¹<br/>[Procedure Activity Procedure](https://hl7.org/cda/us/ccda/3.0.0/StructureDefinition-ProcedureActivityProcedure.html)|FHIR<br/>[Procedure](http://hl7.org/fhir/us/core/STU6.1/StructureDefinition-us-core-procedure.html)|Transform Steps|
|:----|:----|:----|
...
|/author|.recorder<br/>&<br/>**[Provenance](http://hl7.org/fhir/us/core/STU6.1/StructureDefinition-us-core-provenance.html)**|<br/>[CDA ↔ FHIR Provenance](mappingGuidance.html#cda--fhir-provenance) <br/>If a latest author can be identified, map to .recorder.<br/>Any author with a time can be put in Provenance.|
...
The example below is generated from the canonical Myra Jones CCD (procedure-history entry with ICD-9/ICD-10/local translations and target site) and the published FHIR example instance, verified on every build. The section also contains colonoscopy, exercise-stress-test, and SDOH education entries for future variety.

{% include examples/CF-procedure-example.xhtml %}
