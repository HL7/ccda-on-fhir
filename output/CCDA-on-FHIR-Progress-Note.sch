...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Composition">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/ccda/StructureDefinition/CCDA-on-FHIR-Data-Enterer']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/ccda/StructureDefinition/CCDA-on-FHIR-Data-Enterer': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
